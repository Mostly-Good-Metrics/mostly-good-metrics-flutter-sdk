...
- Remove successfully sent events by `client_event_id` in built-in storage so a capped queue cannot discard unsent events; legacy ID-less queues remain readable.
