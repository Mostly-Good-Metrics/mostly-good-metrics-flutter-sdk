...
> **Note:** After calling `resetIdentity()`, the SDK starts a new session and subsequent events fall back to the anonymous ID.
...
- A random anonymous ID (e.g., `$anon_abc123def456`) — generated by the SDK, not derived from the device
